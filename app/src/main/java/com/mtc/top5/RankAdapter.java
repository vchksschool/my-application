...
public class RankAdapter extends RecyclerView.Adapter<RankAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RankAdapter.ViewHolder holder, int position) {
        ...
        System.out.println(userList.get(position).getScore());
        System.out.println(userList.get(position).getRank());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            rankTV = itemView.findViewById(R.id.rankR);
            scoreTV = itemView.findViewById(R.id.scoreR);
